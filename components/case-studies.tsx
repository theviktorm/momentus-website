...
import { ResultChips } from "./ui/result-chips";
...
const featured = {
  ...
  chips: ["$1.53M revenue", "$5K spend", "Solar DTC", "90 days"],
};
...
const others = [
  {
    ...
    chips: ["+25% revenue", "25 days", "DTC footwear · €40M", "Hungary"],
  },
  {
    ...
    chips: ["$30K organic", "50 days", "Coaching", "US"],
  },
  {
    ...
    chips: ["#1 in AI", "27 days", "Healthcare · Specialist", "Central EU"],
  },
];
      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            <ResultChips items={featured.chips} className="mt-4" />
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {others.map((c, i) => (
            ...
            >
              ...
              <ResultChips items={c.chips} className="mt-3" />
